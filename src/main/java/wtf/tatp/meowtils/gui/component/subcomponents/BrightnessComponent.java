...
public class BrightnessComponent extends Component {
    ...
    private static final ResourceLocation BRIGHTNESS_FADE = TextureManager.get("textures/gui/colorpart/brightness_fade.png");
    private static final ResourceLocation BRIGHTNESS_FADE_HOVER = TextureManager.get("textures/gui/colorpart/brightness_fade_hover.png");
    ...
    private final BrightnessValue option;
    private final ModuleComponent component;
    private int offset;
    private int x;
    private int y;

    public BrightnessComponent(BrightnessValue option, ModuleComponent moduleComponent, int offset) {
        this.option = option;
    ...
    public void render() {
        ...
        mc.getTextureManager().bindTexture(this.hovered ? BRIGHTNESS_FADE_HOVER : BRIGHTNESS_FADE);
        Gui.drawModalRectWithCustomSizedTexture(baseX, baseY, 0.0F, 0.0F, 90, 20, 90.0F, 20.0F);
