...
public class ColorComponent extends Component {
    ...
    private static final ResourceLocation COLOR_TRACK = TextureManager.get("textures/gui/colorpart/color_track.png");
    private static final ResourceLocation COLOR_TRACK_HOVER = TextureManager.get("textures/gui/colorpart/color_track_hover.png");
    private static final ResourceLocation COLOR_BUTTON = TextureManager.get("textures/gui/colorpart/color_button.png");

    private boolean hovered;
    private boolean dragging = false;
    private final ColorValue option;
    private final ModuleComponent component;
    private int offset;
    private int x;
    private int y;

    public ColorComponent(ColorValue option, ModuleComponent moduleComponent, int offset) {
        this.option = option;
    ...
    public void render() {
        ...
        int sliderHeight = 6;
        float percent = (float) (this.option.get() / 360.0D);
        ...
        mc.getTextureManager().bindTexture(this.hovered ? COLOR_TRACK_HOVER : COLOR_TRACK);
        Gui.drawModalRectWithCustomSizedTexture(baseX, baseY, 0.0F, 0.0F, 90, 20, 90.0F, 20.0F);
        ...
        Meowtils.fontRenderer.drawStringWithShadow(this.option.getName(), (baseX + 4), (baseY + 5), -1, 4.5F);
    }
    ...
    public void updateComponent(int mouseX, int mouseY) {
        ...
        if (this.dragging && Mouse.isButtonDown(0)) {
            ...
            this.option.set(percent * 360.0D);
